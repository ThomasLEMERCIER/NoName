...
constexpr ScoreExt operator*(std::uint8_t lhs, ScoreExt rhs) { return {static_cast<Score>(rhs.mg * lhs), static_cast<Score>(rhs.eg * lhs) };};
...
constexpr ScoreExt doublePawnPenalty = {-10, -20};
constexpr ScoreExt passedPawnBonus = {70, 120};
constexpr ScoreExt isolatedPawnPenalty = {-10, -20};

constexpr ScoreExt rookOpenFileBonus = {30, 10};
...
constexpr ScoreExt pawnShieldBonus[] = {S(-50, 0), S(-13, 0), S(13, 15), S(36, 46)};

constexpr std::uint32_t knightPhaseValue = 1;
constexpr std::uint32_t bishopPhaseValue = 1;
constexpr std::uint32_t rookPhaseValue   = 2;
constexpr std::uint32_t queenPhaseValue  = 4;

constexpr std::int32_t phaseMidGame = 24;

struct EvaluationData {
    std::uint8_t whitePawnCount;
    std::uint8_t whiteKnightCount;
    std::uint8_t whiteBishopCount;
    std::uint8_t whiteRookCount;
    std::uint8_t whiteQueenCount;

    std::uint8_t blackPawnCount;
    std::uint8_t blackKnightCount;
    std::uint8_t blackBishopCount;
    std::uint8_t blackRookCount;
    std::uint8_t blackQueenCount;
